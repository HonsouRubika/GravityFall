...
public class BottomBackground4 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        _rb.velocity = new Vector2((float)-GameManager.Instance._obstacleSpeedActu * (4f / 4f), 0);
    }
    ...
    void Update()
    {
        ...
        {
            GameManager.Instance.SpawnBotBackground4();
