...
public class BottomBackground2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        _rb.velocity = new Vector2((float)-GameManager.Instance._obstacleSpeedActu * (2f / 4f), 0);
    }
    ...
    void Update()
    {
        ...
        {
            GameManager.Instance.SpawnBotBackground2();
